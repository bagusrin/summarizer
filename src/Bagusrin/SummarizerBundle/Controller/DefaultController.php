...
namespace Bagusrin\SummarizerBundle\Controller;
...
class DefaultController extends Controller
{
    ...
    public function analyzeAction(Request $request)
    {
        try{
            ...
            /* @var $summarizerManager \Bagusrin\SummarizerBundle\Manager\SummarizerManager */
            $summarizerManager = $this->container->get('bagusrin.summarizer.manager');
